...
export const CATS = [
  ...
  { key:"operacoes", label:"Operações", color:"#D97706", subs:[{key:"um_b1",label:"UM B1"},{key:"um_b2",label:"UM B2"},{key:"um_b3",label:"UM B3"},{key:"um_aux_audio",label:"UM Aux. Áudio"},{key:"geradores",label:"Geradores"},{key:"sng",label:"SNG"},{key:"sng_extra",label:"SNG Extra"},{key:"redundancia_sng",label:"Redundância SNG"},{key:"seg_espacial",label:"Seg. Espacial"},{key:"seg_extra",label:"Seg. Extra"},{key:"drone",label:"Drone"},{key:"grua",label:"Grua/Policam"},{key:"dslr",label:"DSLR + Microlink"},{key:"dslrs_transmissor",label:"DSLR + Transmissor"},{key:"refcam",label:"Refcam"},{key:"carrinho",label:"Carrinho"},{key:"especial",label:"Especial"},{key:"goalcam",label:"Goalcam"},{key:"minidrone",label:"Minidrone"},{key:"infra",label:"Infra + Distr."},{key:"downlink",label:"Downlink"},{key:"distribuicao",label:"Distribuição"},{key:"liveu",label:"LiveU"},{key:"starlink",label:"Starlink"},{key:"internet",label:"Internet"},{key:"maquinas",label:"Máquinas"},{key:"montagem_vespera",label:"Montagem Véspera"},{key:"coletivas",label:"Coletivas"},{key:"feed_b",label:"Feed B"},{key:"extra",label:"Extra"}]},
];
