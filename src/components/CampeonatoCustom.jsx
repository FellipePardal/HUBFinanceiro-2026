...
import { CATS, TIPO_COLOR, RADIUS } from "../constants";
      ...
      <aside style={{
        ...
        <button onClick={onBack} title="Voltar ao portal"
          style={{
            ...
            marginBottom:14, boxShadow:`0 6px 16px ${PRIMARY}55`,
          }}>
          ...
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",flexWrap:"wrap",gap:16,paddingBottom:18}}>
            <div style={{ minWidth:0, display:"flex", alignItems:"center", gap:14 }}>
              ...
              <div style={{ minWidth:0 }}>
                ...
                <h1 style={{ fontSize:20, fontWeight:800, margin:0, color:T.text, letterSpacing:"-0.02em" }}>{nome} {edicao}</h1>
            ...
            <div style={{display:"flex",alignItems:"center",gap:10}}>
              <div style={{display:"flex",alignItems:"center",gap:12,padding:"10px 18px",background: T.surfaceAlt || T.bg, border: `1px solid ${T.border}`, borderRadius: RADIUS.lg}}>
                ...
                <div style={{ textAlign:"right" }}>
                  ...
                  <p className="num" style={{ fontSize:22, fontWeight:800, color:"#a855f7", margin:0, filter:ocultar?"blur(8px)":"none", transition:"filter 0.2s", letterSpacing:"-0.02em", lineHeight:1 }}>{fmt(orcadoTotalCampeonato)}</p>
                </div>
              </div>
              <div style={{display:"flex",alignItems:"center",gap:12,padding:"10px 18px",background: T.surfaceAlt || T.bg, border: `1px solid ${T.border}`, borderRadius: RADIUS.lg}}>
                <Activity size={16} color={PRIMARY} strokeWidth={2.25}/>
                <div style={{ textAlign:"right" }}>
                  ...
                  <p className="num" style={{ fontSize:22, fontWeight:800, color: pctGasto>80 ? (T.danger||"#ef4444") : PRIMARY, margin:0, filter:ocultar?"blur(8px)":"none", transition:"filter 0.2s", letterSpacing:"-0.02em", lineHeight:1 }}>{pctGasto}%</p>
                </div>
              </div>
            </div>
          </div>
            ...
            {TABS.map(t => {
              ...
              return (
                <button key={t} onClick={()=>setTab(t)} style={{
                  ...
                  color: isActive ? PRIMARY : T.textMd,
              ...
              <table style={{width:"100%",borderCollapse:"collapse",minWidth:680}}>
                ...
                <tbody>
                  ...
                  <tr style={{borderTop:`2px solid ${T.borderStrong||T.border}`,background:T.surfaceAlt||T.bg,fontWeight:700}}>
                    ...
                    <td className="num" style={{padding:"14px 16px",textAlign:"right",color:PRIMARY,whiteSpace:"nowrap",fontSize:14,fontWeight:700}}>{fmt(totalOrc)}</td>
