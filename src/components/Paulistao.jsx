  ...
  return (
    <div className="page-enter" style={{minHeight:"100vh",background:T.bg,color:T.text,fontFamily:"'Poppins',sans-serif",display:"flex"}}>
      ...
      <div style={{flex:1,minWidth:0,paddingBottom:40,background:T.bg}}>
        ...
        {tab==="apresentações" && <TabApresentacoes jogos={divulgados} servicos={servicosCalc} notasMensais={notasMensais} notas={notas} notasLivemode={notasLivemode} dedupeNotasPorNF={true} grupoDoJogo={grupoDoJogoPaulistao} T={T} apres={apres} setApres={setApres} orcGlobal={orcGlobalVariaveis} mesInicio={4} saldoUsaGasto={true} nomeCampeonato="Paulistão Feminino 2026"/>}
